...
namespace VistaForm
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // Genero Jugadores
            Jugador j1 = new Jugador("Juan", "López", 28, 33222456, 70.5f, 1.82f, Persona.Posicion.Arquero);
            Jugador j2 = new Jugador("José", "Martínez", 28, 33222456, 72f, 1.70f, Persona.Posicion.Defensor);
            Jugador j3 = new Jugador("Pedro", "Gonzalez", 31, 31333444, 73.5f, 1.90f,
            Persona.Posicion.Delantero);
            Jugador j4 = new Jugador("Matías", "Rodríguez", 32, 30443332, 75.5f, 1.75f,
            Persona.Posicion.Central);
            ...
            Persona.Posicion.Delantero);
            Jugador j7 = new Jugador("Martín", "Perez", 26, 36555443, 66.5f, 1.73f, Persona.Posicion.Defensor);
            Jugador j8 = new Jugador("Diego", "Roa", 25, 37456678, 86.5f, 1.94f, Persona.Posicion.Delantero);
